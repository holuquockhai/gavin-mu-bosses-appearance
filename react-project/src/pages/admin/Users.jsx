...
const formatRoles = (roles = []) => roles.map((role) => role.name || role).filter(Boolean);
            ...
            {isLoading ? (
              ...
              users.map((user, index) => (
                <tr key={user.id}>
                  ...
                  <td>
                    <span className={`badge ${user.is_active ? "text-bg-success" : "text-bg-warning"}`}>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <form className="modal-content" onSubmit={handleCreateUser}>
            ...
            <div className="modal-body">
              <UserForm form={createForm} onChange={handleCreateChange} passwordRequired />
...
function UserForm({ form, onChange, passwordRequired = false }) {
  return (
    <>
      <div className="mb-3">
        <label className="form-label" htmlFor={passwordRequired ? "createFullName" : "editFullName"}>
          Full name
        </label>
        <input
      ...
      <div className="mb-3">
        <label className="form-label" htmlFor={passwordRequired ? "createEmail" : "editEmail"}>
          Email
        </label>
        <input
      ...
      <div className="mb-3">
        <label className="form-label" htmlFor={passwordRequired ? "createPassword" : "editPassword"}>
          Password
        </label>
        <input
